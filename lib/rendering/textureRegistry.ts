/**
 * @module lib/rendering/textureRegistry
 * Registro de materiales PBR para tipos de suelo.
 *
 * Presentation Layer (lib/rendering/):
 * Movido de core/infrastructure/ por el Roadmap REMEDIATION-003.
 * Las texturas son una preocupación de presentación, no de dominio.
 *
 * En producción, reemplaza `generateAlbedo` por:
