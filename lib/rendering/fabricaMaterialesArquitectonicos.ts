/**
 * @module lib/rendering/fabricaMaterialesArquitectonicos
 * Fábrica de materiales para objetos arquitectónicos (paredes, techos, etc.).
 *
 * Movido de core/infrastructure/ → lib/rendering/ por Roadmap REMEDIATION-003.
 * Presentation concern: no debe residir en la capa de dominio/infraestructura.
 */
