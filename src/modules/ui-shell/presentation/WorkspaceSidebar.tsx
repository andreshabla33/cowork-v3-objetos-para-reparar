...
export const WorkspaceSidebar: React.FC<WorkspaceSidebarProps> = React.memo(({
  ...
  <aside className="ag-rail hidden md:flex">
    {/* Brand — "U" de urpeverso, vuelve al menú principal.
        Letra stroke clean coherente con el favicon (gradient bg lo aporta
        el CSS .ag-rail__brand; aquí solo el path en color heredado). */}
    <button
      type="button"
      onClick={onNavigateToDashboard}
      className="ag-rail__brand"
      title="Inicio · urpeverso"
      aria-label="Volver al menú principal"
    >
      <Icon
        size={18}
        d="M7 5 L 7 14 A 5 5 0 0 0 17 14 L 17 5"
      />
    </button>
