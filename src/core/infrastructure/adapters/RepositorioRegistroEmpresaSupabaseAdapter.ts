/**
 * @module infrastructure/adapters/RepositorioRegistroEmpresaSupabaseAdapter
 * @description Adapter Supabase: registro de empresa con plantilla inicial y zona.
 *
 * Clean Architecture: Infrastructure layer — implementa IRegistroEmpresaRepositorio.
 * Implementación consolidada desde la ruta legacy (../RepositorioRegistroEmpresaSupabase).
 *
...
export { RepositorioRegistroEmpresaSupabase as RepositorioRegistroEmpresaSupabaseAdapter } from './RepositorioRegistroEmpresaSupabaseAdapter';
