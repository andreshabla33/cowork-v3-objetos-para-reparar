/**
 * @module infrastructure/adapters/InyectorPlantillaEspacioAdapter
 * @description Adapter: inyecta objetos de plantilla en un espacio de trabajo 3D.
 *
 * Clean Architecture: Infrastructure layer — implementa IInyectorPlantillaEspacio.
 * Implementación consolidada desde la ruta legacy (../InyectorPlantillaEspacio).
 *
...
export { InyectorPlantillaEspacio as InyectorPlantillaEspacioAdapter } from './InyectorPlantillaEspacioAdapter';
