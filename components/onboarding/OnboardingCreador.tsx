    ...
    <div className="fixed inset-0 bg-[#050508] flex items-center justify-center p-4 lg:p-3 overflow-y-auto min-h-0">
      ...
      <AnimatePresence mode="wait">
          ...
          >
            <div className="mb-6 lg:mb-5">
              ...
              <div className="relative group mx-auto w-14 h-14 lg:w-12 lg:h-12 mb-4 lg:mb-3">
                <div className="absolute -inset-2 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-xl blur-lg opacity-40 group-hover:opacity-60 transition-opacity duration-500" />
                <div className="relative w-14 h-14 lg:w-12 lg:h-12 bg-gradient-to-br from-blue-600 via-sky-500 to-cyan-500 rounded-xl flex items-center justify-center shadow-2xl">
                  <Sparkles className="w-7 h-7 lg:w-6 lg:h-6 text-white" />
                </div>
              </div>
              <h1 className="text-2xl lg:text-xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-sky-200 to-white mb-2">
            ...
            <div className="space-y-2 lg:space-y-1.5 mb-6 lg:mb-5">
              <div className="flex items-center gap-3 lg:gap-2 p-3 lg:p-2.5 backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] rounded-xl lg:rounded-lg group hover:border-blue-500/30 transition-all">
                <div className="w-8 h-8 lg:w-7 lg:h-7 bg-gradient-to-br from-blue-600/20 to-cyan-500/20 rounded-lg flex items-center justify-center border border-blue-500/20">
                  <span className="text-sky-400 font-black text-sm lg:text-xs">1</span>
                </div>
                <span className="text-zinc-300 font-medium text-sm lg:text-xs">Datos de tu empresa</span>
              </div>
              <div className="flex items-center gap-3 lg:gap-2 p-3 lg:p-2.5 backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] rounded-xl lg:rounded-lg group hover:border-blue-500/30 transition-all">
                <div className="w-8 h-8 lg:w-7 lg:h-7 bg-gradient-to-br from-blue-600/20 to-cyan-500/20 rounded-lg flex items-center justify-center border border-blue-500/20">
                  <span className="text-sky-400 font-black text-sm lg:text-xs">2</span>
                </div>
                <span className="text-zinc-300 font-medium text-sm lg:text-xs">Selecciona tu cargo</span>
              </div>
              <div className="flex items-center gap-3 lg:gap-2 p-3 lg:p-2.5 backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] rounded-xl lg:rounded-lg group hover:border-blue-500/30 transition-all">
                <div className="w-8 h-8 lg:w-7 lg:h-7 bg-gradient-to-br from-blue-600/20 to-cyan-500/20 rounded-lg flex items-center justify-center border border-blue-500/20">
                  <span className="text-sky-400 font-black text-sm lg:text-xs">3</span>
                </div>
                <span className="text-zinc-300 font-medium text-sm lg:text-xs">Elige tu plantilla inicial</span>
              </div>
              <div className="flex items-center gap-3 lg:gap-2 p-3 lg:p-2.5 backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] rounded-xl lg:rounded-lg group hover:border-blue-500/30 transition-all">
                <div className="w-8 h-8 lg:w-7 lg:h-7 bg-gradient-to-br from-blue-600/20 to-cyan-500/20 rounded-lg flex items-center justify-center border border-blue-500/20">
                  <span className="text-sky-400 font-black text-sm lg:text-xs">4</span>
                </div>
            ...
            <button
              ...
              className="relative w-full group overflow-hidden bg-gradient-to-r from-blue-600 via-sky-500 to-cyan-500 text-white py-3 lg:py-2.5 rounded-xl font-black text-xs lg:text-[10px] uppercase tracking-wider transition-all shadow-2xl shadow-blue-600/30 active:scale-[0.98]"
            >
        ...
        {paso === 'empresa' && (
          ...
          >
            <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500/20 via-blue-600/20 to-cyan-500/20 rounded-[40px] lg:rounded-[32px] blur-xl opacity-60" />
            <div className="relative backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] rounded-[36px] lg:rounded-[28px] p-6 lg:p-5">
              <div className="text-center mb-6 lg:mb-5">
                ...
                <div className="relative group mx-auto w-12 h-12 lg:w-10 lg:h-10 mb-3">
                  <div className="absolute -inset-2 bg-gradient-to-r from-sky-400 to-blue-500 rounded-xl blur-lg opacity-40" />
                  <div className="relative w-12 h-12 lg:w-10 lg:h-10 bg-gradient-to-br from-sky-400 to-blue-600 rounded-xl flex items-center justify-center">
                    <Building2 className="w-6 h-6 lg:w-5 lg:h-5 text-white" />
                  </div>
                </div>
                <h2 className="text-2xl lg:text-xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-sky-200 to-white mb-1">Datos de tu empresa</h2>
                <p className="text-zinc-500 text-xs lg:text-[10px]">
                  Vincula tu organización a <span className="text-sky-400 font-medium">{espacioCreado?.nombre}</span>
                </p>
              </div>
              ...
              <div className="space-y-3 lg:space-y-2.5 mb-5 lg:mb-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3.5 lg:py-3 bg-black/40 border border-white/5 rounded-xl text-sm lg:text-xs text-white placeholder-zinc-700 focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 outline-none transition-all"
                  />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-3.5 lg:py-3 bg-black/40 border border-white/5 rounded-xl text-sm lg:text-xs text-white focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 outline-none transition-all"
                    >
              ...
              <div className="space-y-2.5">
                <button
                  ...
                  className="relative w-full group overflow-hidden bg-gradient-to-r from-sky-400 via-blue-600 to-cyan-500 text-white py-3.5 lg:py-3 rounded-xl font-black text-xs lg:text-[10px] uppercase tracking-[0.15em] transition-all shadow-2xl shadow-blue-600/30 active:scale-[0.98] disabled:opacity-50"
                >
                  <span className="absolute inset-0 bg-gradient-to-r from-sky-400 via-blue-500 to-cyan-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <span className="relative flex items-center justify-center gap-2">
                    {loading ? (
                      <>
        ...
        {paso === 'plantilla' && (
          ...
          >
            <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500/20 via-blue-600/20 to-sky-400/20 rounded-[40px] lg:rounded-[32px] blur-xl opacity-60" />
            <div className="relative backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] rounded-[36px] lg:rounded-[28px] p-6 lg:p-5">
              <div className="text-center mb-6 lg:mb-5">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-cyan-500/20 to-blue-600/20 border border-cyan-400/30 rounded-full text-cyan-300 text-[9px] lg:text-[8px] font-bold uppercase tracking-wider mb-3">
                  Paso 3 de 4
                </div>
                <div className="relative group mx-auto w-12 h-12 lg:w-10 lg:h-10 mb-3">
                  <div className="absolute -inset-2 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-xl blur-lg opacity-40" />
                  <div className="relative w-12 h-12 lg:w-10 lg:h-10 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-xl flex items-center justify-center">
              ...
              <div className="mt-5 grid grid-cols-2 gap-2.5">
                ...
                <button
                  ...
                  disabled={loading}
                  className="relative w-full group overflow-hidden bg-gradient-to-r from-cyan-500 via-blue-600 to-sky-400 text-white py-3 lg:py-2.5 rounded-xl font-black text-xs lg:text-[10px] uppercase tracking-[0.15em] transition-all shadow-2xl shadow-blue-600/30 active:scale-[0.98] disabled:opacity-50"
                >
                  <span className="absolute inset-0 bg-gradient-to-r from-cyan-400 via-blue-500 to-sky-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <span className="relative flex items-center justify-center gap-2">
                    {loading ? (
                      <>
                        <div className="w-4 h-4 lg:w-3.5 lg:h-3.5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
          ...
          >
            ...
            <div className="relative backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] rounded-[36px] lg:rounded-[28px] p-6 lg:p-5">
              <div className="text-center mb-6 lg:mb-5">
                ...
                <h2 className="text-2xl lg:text-xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-sky-200 to-white mb-1">Invita a tu equipo</h2>
                <p className="text-zinc-500 text-xs lg:text-[10px]">
                  Añade los emails para invitar a <span className="text-sky-400 font-medium">{espacioCreado?.nombre}</span>
                </p>
              </div>
                  ...
                  <div key={index} className="flex gap-2">
                    <div className="flex-1 relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-3 py-3.5 lg:py-3 bg-black/40 border border-white/5 rounded-xl text-sm lg:text-xs text-white placeholder-zinc-700 focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 outline-none transition-all"
                      />
                    </div>
              ...
              <button
                ...
                className="w-full py-3 lg:py-2.5 border-2 border-dashed border-white/[0.06] rounded-xl text-zinc-600 hover:text-sky-400 hover:border-blue-500/30 transition-all flex items-center justify-center gap-2 mb-4 lg:mb-3 text-xs"
              >
              ...
              <div className="space-y-2.5">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full py-2 text-zinc-500 hover:text-sky-400 transition-colors text-[10px] lg:text-[9px] font-bold uppercase tracking-widest"
                >
                  Omitir por ahora
                </button>
              </div>
