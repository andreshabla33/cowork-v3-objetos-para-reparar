...
export const OnboardingCargoView: React.FC = () => {
 ...
 <p className="text-[#4A6485] text-xs font-bold uppercase tracking-widest">Cargando...</p>
 </div>
 </div>
 );
 }
 ...
 className="px-5 py-2.5 bg-red-500 text-[#0B2240] rounded-xl text-xs font-black uppercase tracking-widest hover:bg-red-600 transition-colors"
 >
 Ir al inicio
 </button>
 </div>
 ...
 esAdmin ? 'bg-gradient-to-r from-[#4FB0FF] to-[#2E96F5]' : 'bg-gradient-to-r from-[#4FB0FF] to-[#2E96F5]'
 }`} />
 <div className={`relative w-14 h-14 lg:w-12 lg:h-12 rounded-xl flex items-center justify-center ${
 esAdmin ? 'bg-gradient-to-br from-[#4FB0FF] to-[#2E96F5]' : 'bg-gradient-to-br from-[#4FB0FF] to-[#2E96F5]'
 }`}>
 ...
 <p className="text-[#4A6485] text-xs lg:text-[10px] mb-4">
 Te uniste a <span className="text-[#1E86E5] font-medium">{state.espacioNombre}</span>
 {state.invitadorNombre && (
 <span> por invitación de <span className="text-[#1E86E5] font-medium">{state.invitadorNombre}</span></span>
 )}
 </p>

 {esAdmin ? (
 <div className="bg-[#2E96F5]/10 border border-[rgba(46,150,245,0.3)]/20 rounded-xl p-4 lg:p-3 text-left mb-4">
 <h3 className="text-[#1E86E5] font-black text-[10px] uppercase tracking-widest mb-2">Como administrador podrás:</h3>
 <ul className="space-y-1.5 text-[11px] lg:text-[10px] text-[#4A6485]">
 <li className="flex items-center gap-2"><span className="text-[#1E86E5]">✓</span> Invitar y gestionar miembros del equipo</li>
 <li className="flex items-center gap-2"><span className="text-[#1E86E5]">✓</span> Configurar métricas de análisis conductual</li>
 <li className="flex items-center gap-2"><span className="text-[#1E86E5]">✓</span> Administrar departamentos y roles</li>
 <li className="flex items-center gap-2"><span className="text-[#1E86E5]">✓</span> Acceder a configuraciones avanzadas del espacio</li>
 </ul>
 </div>
 ) : (
 <div className="bg-[#2E96F5]/10 border border-[rgba(46,150,245,0.3)]/20 rounded-xl p-4 lg:p-3 text-left mb-4">
 <h3 className="text-[#1E86E5] font-black text-[10px] uppercase tracking-widest mb-2">En tu espacio podrás:</h3>
 <ul className="space-y-1.5 text-[11px] lg:text-[10px] text-[#4A6485]">
 <li className="flex items-center gap-2"><span className="text-[#1E86E5]">✓</span> Colaborar en el espacio virtual 3D</li>
 <li className="flex items-center gap-2"><span className="text-[#1E86E5]">✓</span> Participar en reuniones con análisis inteligente</li>
 <li className="flex items-center gap-2"><span className="text-[#1E86E5]">✓</span> Gestionar tareas y comunicarte con tu equipo</li>
 <li className="flex items-center gap-2"><span className="text-[#1E86E5]">✓</span> Personalizar tu avatar y experiencia</li>
 </ul>
 </div>
 )}

 <p className="text-[#6B83A0] text-[10px] lg:text-[9px] mb-4">
 Primero, cuéntanos cuál es tu cargo para personalizar tu experiencia.
 </p>

 <button
 onClick={() => setState((prev) => ({ ...prev, paso: 'cargo' }))}
 className="relative w-full group overflow-hidden bg-gradient-to-r from-[#4FB0FF] to-[#2E96F5] text-white py-3 lg:py-2.5 rounded-xl font-black text-xs lg:text-[10px] uppercase tracking-[0.15em] transition-all shadow-2xl shadow-[0_4px_14px_-4px_rgba(46,150,245,0.3)] active:scale-[0.98]"
 >
 ...
 <button
 onClick={handleBack}
 className="mb-3 text-[#4A6485] hover:text-[#1E86E5] flex items-center gap-1.5 mx-auto text-[10px] font-bold uppercase tracking-widest transition-colors"
 >
 ← Volver a selección de cargo
 </button>
 <div className="inline-flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-[#4FB0FF]/20 to-[#2E96F5]/20 border border-[rgba(46,150,245,0.3)]/30 rounded-full text-[#1E86E5] text-[9px] font-bold uppercase tracking-wider mb-3">
 Paso 2 de 3
 </div>
 <h1 className="text-2xl lg:text-xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#0B2240] via-[#1E86E5] to-[#0B2240] mb-1">¿A qué departamento perteneces?</h1>
 <p className="text-[#4A6485] text-xs lg:text-[10px]">
 Selecciona tu departamento en <span className="text-[#1E86E5] font-medium">{state.espacioNombre}</span>
 </p>
 </div>
 ...
 disabled={saving}
 className="group p-4 lg:p-3 rounded-xl border border-[rgba(46,150,245,0.14)] bg-white/50 backdrop-blur-xl hover:border-[rgba(46,150,245,0.3)]/40 transition-all duration-200 text-left disabled:opacity-50"
 >
 <div
 ...
 <h3 className="text-sm lg:text-xs font-bold text-[#0B2240] group-hover:text-[#1E86E5] transition-colors">
 {dept.nombre}
 </h3>
 <div
 ...
 <div className="w-5 h-5 border-2 border-[rgba(46,150,245,0.3)]/30 border-[#2E96F5] border-t-transparent rounded-full animate-spin mx-auto" />
 <p className="text-[#4A6485] text-[10px] font-bold uppercase tracking-widest mt-2">Guardando...</p>
 </div>
 )}
 </div>
 </div>
