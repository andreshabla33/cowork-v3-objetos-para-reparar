  ...
  return (
    <div className="fixed inset-0 bg-[#050508] flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-4xl relative z-10">
        {/* Outer glow border */}
        <div className="absolute -inset-1 bg-gradient-to-r from-violet-600/20 via-fuchsia-600/20 to-cyan-500/20 rounded-[32px] blur-xl opacity-60" />
        ...
        <div className="relative backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] rounded-[28px] p-6">
          ...
          <div className="text-center mb-5">
            <div className="relative group mx-auto w-12 h-12 mb-3">
              <div className="absolute -inset-2 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 blur-lg opacity-40" />
              <div className="relative w-12 h-12 rounded-xl bg-gradient-to-br from-violet-600 via-fuchsia-600 to-cyan-500 flex items-center justify-center">
                <span className="text-xl">🎭</span>
              </div>
            </div>
            <h1 className="text-xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-violet-200 to-white mb-1">
              Elige tu avatar
            </h1>
          ...
          <div className="flex items-center justify-between mt-5 pt-4 border-t border-white/[0.06]">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 disabled:from-zinc-700 disabled:to-zinc-700 disabled:cursor-not-allowed text-white rounded-xl text-xs font-black uppercase tracking-widest transition-all shadow-lg shadow-violet-600/20 hover:shadow-violet-500/30"
            >
              Continuar
            </button>
          </div>
