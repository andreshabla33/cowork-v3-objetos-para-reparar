      ...
      <div className="w-full max-w-md my-auto relative z-10">
        ...
        <div className="relative backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] rounded-[36px] p-6 shadow-2xl text-center space-y-5">
          <div className="relative mx-auto w-16 h-16">
            <div className="absolute -inset-2 bg-gradient-to-r from-violet-600 to-cyan-500 rounded-full blur-xl opacity-50 animate-pulse" />
            <div className="relative w-16 h-16 bg-gradient-to-br from-violet-600 via-fuchsia-600 to-cyan-500 rounded-full flex items-center justify-center">
          ...
          <div>
            <h1 className="text-2xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white via-violet-200 to-white mb-2">
          ...
          <button
            ...
            className="w-full py-3 rounded-xl border border-white/10 bg-white/[0.03] text-zinc-300 font-black text-[10px] uppercase tracking-[0.15em] hover:border-violet-500/30 transition-all"
          >
            Volver al inicio
          </button>
        </div>
