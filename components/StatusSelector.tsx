...
const STATUS_OPTIONS = [
 ...
 { value: PresenceStatus.DND, label: 'No molestar', color: 'bg-[#2E96F5]', icon: '🟣' },
];
...
export const StatusSelector: React.FC = () => {
 ...
 className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/50 hover:bg-[rgba(46,150,245,0.08)] transition-all border border-[rgba(46,150,245,0.14)] hover:border-[rgba(46,150,245,0.16)]"
 >
 ...
 {isOpen && (
 <div className="absolute top-full left-0 mt-2 w-64 bg-white/60/95 backdrop-blur-xl rounded-2xl border border-[rgba(46,150,245,0.14)] shadow-2xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
 <div className="p-2">
 ...
 ? 'bg-[rgba(46,150,245,0.08)]' 
 : 'hover:bg-[rgba(46,150,245,0.08)]'
 }`}
 >
 ...
 <div className="border-t border-[rgba(46,150,245,0.14)] p-2">
 ...
 maxLength={50}
 className="w-full bg-white/50 border border-[rgba(46,150,245,0.14)] rounded-xl px-3 py-2.5 text-[12px] focus:outline-none focus:border-indigo-500/50 placeholder:opacity-30"
 />
 ...
 className="px-3 py-1.5 bg-white/50 hover:bg-[rgba(46,150,245,0.08)] rounded-lg text-[10px] font-bold transition-colors"
 >
 Cancelar
 </button>
 </div>
 ...
 className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-[rgba(46,150,245,0.08)] transition-all"
 >
