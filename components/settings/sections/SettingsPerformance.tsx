...
export const SettingsPerformance: React.FC<SettingsPerformanceProps> = ({
  ...
  return (
    <div>
      ...
      <div className="mt-8 p-4 bg-[rgba(46,150,245,0.1)] border border-[rgba(46,150,245,0.2)] rounded-xl">
        <div className="flex items-start gap-3">
          <svg className="w-5 h-5 text-[#1E86E5] mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
          </svg>
          <div>
            <p className="text-sm font-medium text-[#1E86E5]">{currentLang === 'en' ? 'Performance tip' : currentLang === 'pt' ? 'Dica de desempenho' : 'Consejo de rendimiento'}</p>
