  ...
  switch (emoji) {
    ...
    case '✨':
      return {
        ...
        spread: 1.25,
        lift: 188,
        shellClassName: 'rounded-full border border-sky-300/20 bg-blue-500/10 px-4 py-2 text-5xl shadow-2xl backdrop-blur-md',
        labelClassName: 'max-w-[220px] rounded-full border border-sky-300/20 bg-black/72 px-3 py-1.5 text-center text-xs font-semibold text-sky-100 shadow-lg backdrop-blur-md',
        particleAnimation: 'meetingReactionParticleSoft 1.9s ease-out forwards',
        burstAnimation: 'meetingReactionBurstSoft 2.9s ease-out forwards',
