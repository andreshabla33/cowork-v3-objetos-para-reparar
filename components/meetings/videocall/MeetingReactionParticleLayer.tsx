  ...
  switch (emoji) {
    ...
    case '😮':
      return {
        ...
        labelClassName: 'max-w-[220px] rounded-full border border-white/10 bg-black/72 px-3 py-1.5 text-center text-xs font-semibold text-white/95 shadow-lg backdrop-blur-md',
    ...
    case '✨':
      return {
        ...
        spread: 1.25,
        lift: 188,
        shellClassName: 'rounded-full border border-violet-300/20 bg-violet-500/10 px-4 py-2 text-5xl shadow-2xl backdrop-blur-md',
        labelClassName: 'max-w-[220px] rounded-full border border-violet-300/20 bg-black/72 px-3 py-1.5 text-center text-xs font-semibold text-violet-100 shadow-lg backdrop-blur-md',
        particleAnimation: 'meetingReactionParticleSoft 1.9s ease-out forwards',
        burstAnimation: 'meetingReactionBurstSoft 2.9s ease-out forwards',
    ...
    default:
      return {
        ...
        spread: 1.45,
        lift: 168,
        shellClassName: 'rounded-full border border-white/10 bg-white/10 px-4 py-2 text-5xl shadow-2xl backdrop-blur-md',
        labelClassName: 'max-w-[220px] rounded-full border border-white/10 bg-black/72 px-3 py-1.5 text-center text-xs font-semibold text-white/95 shadow-lg backdrop-blur-md',
