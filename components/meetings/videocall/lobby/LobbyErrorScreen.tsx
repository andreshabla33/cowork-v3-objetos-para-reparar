...
export const LobbyErrorScreen: React.FC<LobbyErrorScreenProps> = ({ message }) => (
  <div className="fixed inset-0 flex items-center justify-center bg-[#050508] p-6">
    ...
    <div className="relative w-full max-w-sm rounded-2xl border border-[rgba(46,150,245,0.14)] bg-[rgba(46,150,245,0.06)] p-8 text-center shadow-2xl backdrop-blur-xl">
      {/* Icon */}
      ...
      <p className="mb-6 text-sm leading-relaxed text-[#4A6485]">{message}</p>

      <a
        href="/"
        className="inline-flex items-center gap-2 rounded-xl bg-white/60 border border-[rgba(46,150,245,0.14)] px-5 py-2.5 text-sm font-black uppercase tracking-widest text-white transition-all hover:bg-white active:scale-[0.98]"
      >
