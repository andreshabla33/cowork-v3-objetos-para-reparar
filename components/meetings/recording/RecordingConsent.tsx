      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 max-w-md w-full shadow-2xl animate-in zoom-in-95 duration-300">
        ...
        <div className="bg-zinc-800/50 rounded-xl p-4 mb-5">
          <p className="text-sm text-zinc-300 leading-relaxed">
            ...
            {meetingTitle ? (
              <> la reunión "<span className="text-blue-500">{meetingTitle}</span>"</>
            ) : (
              ' esta reunión'
            )}.
          </p>
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={onAccept}
            className="flex-1 px-4 py-2.5 bg-blue-700 hover:bg-blue-600 text-white rounded-xl text-sm font-medium transition-colors"
          >
            Aceptar
          </button>
        </div>
