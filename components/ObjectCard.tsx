...
export const ObjectCard: React.FC<ObjectCardProps> = ({
 ...
 {/* Fallback icon */}
 <div className={`flex h-full w-full absolute inset-0 items-center justify-center text-2xl text-[#1E86E5]/30 z-0 ${(hasThumbnail && !imageError) || hasBuiltIn ? 'hidden' : ''}`}>
 📦
 </div>

 {/* Badges compactos */}
 {interactuable && (
 <div className="absolute top-0.5 right-0.5 z-10 rounded-full bg-[#2E96F5]/80 w-4 h-4 flex items-center justify-center shadow-sm">
 ...
 <div className="flex h-4 items-center rounded-br-md border-r border-b border-emerald-300/25 bg-white/50 px-1.5 shadow-[0_2px_8px_rgba(16,185,129,0.14)] backdrop-blur-[2px]">
 ...
 <svg className="w-3 h-3 text-[#1E86E5] drop-shadow-md" viewBox="0 0 24 24" fill="currentColor">
 ...
 <p className="text-[7px] font-bold text-[#0B2240]/80 text-center truncate leading-tight uppercase tracking-wider">
 {nombre}
 </p>
 </div>
