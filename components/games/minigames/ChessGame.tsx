...
export const ChessGame: React.FC<ChessGameProps> = ({ 
 ...
 ${isLight ? 'bg-[#ECF4FF]' : 'bg-[rgba(46,150,245,0.2)]'}
 ${isSelected ? 'ring-4 ring-[#2E96F5] ring-inset z-10' : ''}
 ...
 {/* Coordenadas */}
 {colIndex === 0 && (
 <span className={`absolute left-1 top-0 text-[10px] font-bold ${isLight ? 'text-[#1E86E5]' : 'text-[#4FB0FF]'}`}>
 {rank + 1}
 </span>
 )}
 {rowIndex === 7 && (
 <span className={`absolute right-1 bottom-0 text-[10px] font-bold ${isLight ? 'text-[#1E86E5]' : 'text-[#4FB0FF]'}`}>
 ...
 initial={{ scale: 0 }}
 animate={{ scale: 1 }}
 className={`absolute ${piece ? 'inset-0 border-4 border-[rgba(46,150,245,0.3)] rounded-sm' : 'w-4 h-4 rounded-full bg-[#2E96F5]/50'}`}
 />
 )}
 ...
 className="fixed inset-0 z-50 flex items-center justify-center p-4 lg:p-3 bg-[#0B2240]/35 backdrop-blur-[10px] backdrop-blur-xl"
 >
 <div className="relative w-full max-w-4xl lg:max-w-3xl md:max-w-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl lg:rounded-xl overflow-hidden border border-[rgba(46,150,245,0.14)] shadow-2xl max-h-[90vh] lg:max-h-[85vh] flex flex-col">
 {/* Header - Compacto */}
 <div className="flex items-center justify-between px-4 lg:px-3 py-3 lg:py-2 border-b border-[rgba(46,150,245,0.14)] bg-white/70">
 <div className="flex items-center gap-2.5 lg:gap-2">
 <div className="w-9 h-9 lg:w-8 lg:h-8 rounded-xl lg:rounded-lg bg-gradient-to-br from-[#4FB0FF] to-[#2E96F5] flex items-center justify-center shadow-lg">
 <Crown className="w-5 h-5 lg:w-4 lg:h-4 text-[#0B2240]" />
 </div>
 <div>
 <h2 className="text-lg lg:text-base font-bold text-[#0B2240]">Ajedrez</h2>
 <p className="text-xs lg:text-[10px] text-[#4A6485]">
 ...
 className="p-1.5 lg:p-1 rounded-lg bg-white/50 hover:bg-[rgba(46,150,245,0.08)] text-[#4A6485] hover:text-[#0B2240] transition-colors"
 >
 {soundEnabled ? <Volume2 className="w-4 h-4 lg:w-3.5 lg:h-3.5" /> : <VolumeX className="w-4 h-4 lg:w-3.5 lg:h-3.5" />}
 </button>
 <button
 onClick={() => setShowChat(!showChat)}
 className="p-1.5 lg:p-1 rounded-lg bg-white/50 hover:bg-[rgba(46,150,245,0.08)] text-[#4A6485] hover:text-[#0B2240] transition-colors relative"
 >
 <MessageCircle className="w-4 h-4 lg:w-3.5 lg:h-3.5" />
 </button>
 <button
 onClick={onClose}
 className="p-1.5 lg:p-1 rounded-lg bg-white/50 hover:bg-red-500/20 text-[#4A6485] hover:text-red-400 transition-colors"
 >
 ...
 <div>
 <p className="text-[#0B2240] font-medium">
 {boardFlipped 
 ? currentUserName 
 ...
 chess.turn() === (boardFlipped ? 'w' : 'b') ? 'bg-emerald-500 text-[#0B2240]' : 'bg-slate-700 text-[#4A6485]'
 }`}>
 ...
 {/* Tablero */}
 <div className="relative aspect-square rounded-2xl overflow-hidden shadow-2xl border-4 border-[rgba(46,150,245,0.3)]">
 ...
 className="w-20 h-20 mx-auto rounded-3xl bg-gradient-to-br from-[#4FB0FF] to-[#2E96F5] flex items-center justify-center shadow-2xl mb-4"
 >
 <Crown className="w-10 h-10 text-[#0B2240]" />
 </motion.div>
 <h3 className="text-3xl font-bold text-[#0B2240] mb-2">Ajedrez</h3>
 <p className="text-[#4A6485]">Configura tu partida</p>
 </div>

 {/* Modo de juego */}
 <div className="space-y-3">
 <label className="text-sm font-medium text-[#1B3A5C] flex items-center gap-2">
 ...
 gameMode === mode
 ? 'bg-[rgba(46,150,245,0.12)] border-[rgba(46,150,245,0.3)] text-[#1E86E5]'
 : 'bg-white/50 border-[rgba(46,150,245,0.14)] text-[#4A6485] hover:bg-[rgba(46,150,245,0.08)] hover:border-[rgba(46,150,245,0.16)]'
 }`}
 >
 ...
 : 'bg-white/50 border-[rgba(46,150,245,0.14)] text-[#4A6485] hover:bg-[rgba(46,150,245,0.08)]'
 }`}
 >
 {label}
 </button>
 ...
 <div className="p-4 rounded-xl bg-[rgba(46,150,245,0.1)] border border-[rgba(46,150,245,0.3)]/30">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 rounded-full bg-[rgba(46,150,245,0.12)] flex items-center justify-center">
 <motion.div
 animate={{ rotate: 360 }}
 transition={{ duration: 1, repeat: Infinity, ease: 'linear' }}
 >
 <Zap className="w-5 h-5 text-[#1E86E5]" />
 </motion.div>
 </div>
 <div className="flex-1">
 <p className="text-[#0B2240] font-medium">Esperando a {selectedMiembro?.nombre}...</p>
 <p className="text-[#6B83A0] text-xs">La invitación expira en 5 minutos</p>
 </div>
 <button
 onClick={cancelarInvitacion}
 className="p-2 rounded-lg bg-[rgba(46,150,245,0.08)] hover:bg-white/20 text-[#4A6485]"
 >
 <X className="w-4 h-4" />
 </button>
 </div>
 ...
 <div className="p-4 rounded-xl bg-white/50 border border-[rgba(46,150,245,0.14)] text-[#6B83A0] text-center">
 Cargando miembros...
 </div>
 ) : miembrosEspacio.length === 0 ? (
 <div className="p-4 rounded-xl bg-white/50 border border-[rgba(46,150,245,0.14)] text-[#6B83A0] text-center text-sm">
 ...
 className="w-full p-3 rounded-xl bg-white/50 border border-[rgba(46,150,245,0.14)] hover:bg-[rgba(46,150,245,0.08)] hover:border-[rgba(46,150,245,0.3)]/30 transition-all flex items-center gap-3"
 >
 <div className="relative">
 <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#4FB0FF] to-[#2E96F5] flex items-center justify-center text-white font-bold">
 ...
 miembro.estado_disponibilidad === 'away' ? 'bg-[#2E96F5]' : 'bg-[#9CB0CA]'
 }`} />
 </div>
 <div className="flex-1 text-left">
 <p className="text-[#0B2240] font-medium">{miembro.nombre}</p>
 <p className="text-[#9CB0CA] text-xs capitalize">
 ...
 <Swords className="w-5 h-5 text-[#1E86E5]" />
 </button>
 ))}
 </div>
 )}
 ...
 playerColor === 'w'
 ? 'bg-white/20 border-white text-[#0B2240]'
 : 'bg-white/50 border-[rgba(46,150,245,0.14)] text-[#4A6485] hover:bg-[rgba(46,150,245,0.08)]'
 }`}
 >
 ...
 className={`p-4 rounded-2xl border-2 transition-all flex items-center justify-center gap-3 ${
 playerColor === 'b'
 ? 'bg-slate-700/50 border-slate-500 text-[#0B2240]'
 : 'bg-white/50 border-[rgba(46,150,245,0.14)] text-[#4A6485] hover:bg-[rgba(46,150,245,0.08)]'
 }`}
 >
 <div className="w-8 h-8 rounded-full bg-white/50 border-2 border-slate-600 shadow-lg" />
 ...
 whileTap={{ scale: 0.98 }}
 onClick={startGame}
 className="w-full py-4 bg-gradient-to-r from-[#4FB0FF] to-[#2E96F5] text-white font-bold rounded-2xl hover:from-[#3BA3F7] hover:to-[#1E86E5] transition-all flex items-center justify-center gap-3 shadow-xl"
 >
 ...
 initial={{ opacity: 0 }}
 animate={{ opacity: 1 }}
 className="absolute inset-0 bg-[#0B2240]/35 backdrop-blur-[10px] backdrop-blur-sm flex flex-col items-center justify-center"
 >
 <motion.div
 initial={{ scale: 0 }}
 animate={{ scale: 1 }}
 transition={{ type: 'spring', damping: 10 }}
 >
 <Trophy className="w-20 h-20 text-[#1E86E5] mb-4" />
 </motion.div>
 <h3 className="text-3xl font-bold text-[#0B2240] mb-2">
 {chess.isCheckmate() 
 ...
 className="px-6 py-3 bg-gradient-to-r from-[#4FB0FF] to-[#2E96F5] text-white font-bold rounded-xl hover:from-[#3BA3F7] hover:to-[#1E86E5] transition-all flex items-center gap-2"
 >
 ...
 <button
 onClick={onClose}
 className="px-6 py-3 bg-[rgba(46,150,245,0.08)] text-[#0B2240] font-bold rounded-xl hover:bg-white/20 transition-all"
 >
 Salir
 </button>
 </div>
 ...
 <div className={`px-4 py-2 rounded-xl font-mono text-lg font-bold ${
 chess.turn() === (boardFlipped ? 'b' : 'w') ? 'bg-emerald-500 text-[#0B2240]' : 'bg-slate-700 text-[#4A6485]'
 }`}>
 ...
 className="px-4 py-2 bg-[rgba(46,150,245,0.08)] hover:bg-white/20 text-[#0B2240] rounded-xl transition-colors flex items-center gap-2"
 >
 ...
 <div className="w-80 border-l border-[rgba(46,150,245,0.14)] bg-white/50 flex flex-col">
 {/* Tabs */}
 <div className="flex border-b border-[rgba(46,150,245,0.14)]">
 <button
 onClick={() => setShowChat(false)}
 className={`flex-1 px-4 py-3 text-sm font-medium transition-colors ${
 !showChat ? 'text-[#0B2240] bg-[rgba(46,150,245,0.08)]' : 'text-[#6B83A0] hover:text-[#0B2240]'
 }`}
 >
 Movimientos
 </button>
 ...
 <span className="w-8 text-[#9CB0CA]">{idx + 1}.</span>
 <button
 onClick={() => setCurrentMoveIndex(idx * 2)}
 className={`px-2 py-1 rounded ${
 currentMoveIndex === idx * 2 ? 'bg-[rgba(46,150,245,0.15)] text-[#1E86E5]' : 'text-[#0B2240] hover:bg-[rgba(46,150,245,0.08)]'
 }`}
 >
 {whiteMove?.san}
 </button>
 ...
 currentMoveIndex === idx * 2 + 1 ? 'bg-[rgba(46,150,245,0.15)] text-[#1E86E5]' : 'text-[#0B2240] hover:bg-[rgba(46,150,245,0.08)]'
 }`}
 >
 {blackMove.san}
 </button>
 ...
 <p className="text-[#9CB0CA] text-center mt-8">
 ...
 ? 'bg-[rgba(46,150,245,0.15)] text-[#0B2240]' 
 : 'bg-[rgba(46,150,245,0.08)] text-[#0B2240]'
 }`}>
 <p className="text-xs text-[#6B83A0] mb-1">{msg.from}</p>
 ...
 <div className="p-3 border-t border-[rgba(46,150,245,0.14)]">
 ...
 className="flex-1 bg-[rgba(46,150,245,0.08)] border border-[rgba(46,150,245,0.14)] rounded-xl px-3 py-2 text-[#0B2240] text-sm placeholder-[#9CB0CA] focus:outline-none focus:border-[rgba(46,150,245,0.3)]/50"
 />
 <button
 onClick={sendChatMessage}
 className="p-2 bg-[#2E96F5] hover:bg-[#4FB0FF] text-[#0B2240] rounded-xl transition-colors"
 >
 ...
 <div className="flex items-center justify-center gap-2 p-3 border-t border-[rgba(46,150,245,0.14)]">
 <button
 onClick={() => setCurrentMoveIndex(0)}
 disabled={currentMoveIndex <= 0}
 className="p-2 rounded-lg bg-[rgba(46,150,245,0.08)] hover:bg-white/20 disabled:opacity-30 disabled:cursor-not-allowed text-[#0B2240]"
 >
