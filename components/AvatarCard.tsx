...
export const AvatarCard: React.FC<AvatarCardProps> = ({
 ...
 <span className="text-xl font-black text-[#1E86E5]/40 drop-shadow-sm select-none">
 {nombre.substring(0, 2).toUpperCase()}
 </span>
 <span className="text-[10px] mt-1 text-[#1E86E5]/20">🧍</span>
 </div>
 </div>
 )}
 ...
 {/* Equipado badge */}
 {equipado && (
 <div className="absolute top-0.5 right-0.5 z-10 rounded-full bg-[#2E96F5] w-4 h-4 flex items-center justify-center shadow-md">
