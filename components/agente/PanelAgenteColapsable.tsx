    ...
    <div className="border-t border-white/5 bg-black/20 mt-auto">
      ...
      >
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-blue-700 flex items-center justify-center text-white shadow-lg animate-pulse">
            ✨
          </div>
          <div>
            <p className="text-[10px] font-black uppercase tracking-widest text-blue-500">Viben Assistant</p>
      ...
      {isOpen && (
        <div className="p-4 pt-0 animate-in slide-in-from-bottom-2 duration-300">
          <div className="bg-zinc-900/50 rounded-xl p-3 border border-blue-600/20">
            <p className="text-[10px] text-zinc-400 leading-relaxed mb-3">
              ¿En qué puedo ayudarte hoy? Puedo resumir canales, crear tareas o traducir mensajes.
            </p>
            <button className="w-full py-2 bg-blue-700 hover:bg-blue-600 text-white rounded-lg text-[9px] font-black uppercase tracking-widest transition-all">
              Abrir Chat Completo
            </button>
          </div>
        </div>
